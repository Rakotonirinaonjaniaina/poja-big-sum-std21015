package com.company.sqlite.unit;
...
import com.company.sqlite.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.company.sqlite.endpoint.event.gen.UuidCreated", payload);
